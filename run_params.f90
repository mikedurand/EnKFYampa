SUBROUTINE RUN_PARAMS(N_YR,N_T,N_M,MY,NY,N_YP,N_Y,N_YS,N_U,N_R,N_ZR,N_ZP,N_Z,&
...
INTEGER,INTENT(IN)::N_YR,N_T,N_M,MY,NY,N_YP,N_Y,N_YS,N_U,N_R,N_ZR,N_Z,N_A,N_F
...
!J=0
!DO I=7+N_DAYS_STRT*24,N_T,12 !Wait N_DAYS_START days before beginning updates
!  J=J+1
!  IF(J.LE.N_M)THEN
!    MEASTIMES(J)=I
!  END IF
...
! 6) DEFINE FREQUENCIES AND ANGLES FOR TEST
