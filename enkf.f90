...
INTEGER::N_Y,N_YR,N_T,N_M,N_YP,N_YS,N_Z,N_ZR,N_R,N_U,N_A,N_X,N_C,MY,NY,I,N_PF
...
READ(1,*) 
READ(1,10) N_M
!SIZE OF DOMAIN IN X DIMENSION, MY
READ(1,*) 
READ(1,10) MY
!SIZE OF DOMAIN IN Y DIMENSION, NY
READ(1,*)
READ(1,10) NY
...
WRITE(N_ZRC,*) N_ZR
READ(1,*) 
READ(1,'('//N_ZRC//'(I3,1X))') (N_ZP(I),I=1,N_ZR) 
...
10 FORMAT(I5)
CLOSE(1)
N_YP=MY*NY     !COMPUTE TOTAL NUMBER OF Y PIXELS
...
CALL RUN_PARAMS(N_YR,N_T,N_M,MY,NY,N_YP,N_Y,N_YS,N_U,N_R,N_ZR,N_ZP,N_Z,&
...
DO I=1,25
  READ(5,40) (ELEVATION( (I-1)*25+J ),J=1,25)
END DO
CLOSE(5)
40 FORMAT(25(F12.5)) 
...
! CALL MPE_LOG_EVENT(9,M,'BEGIN PROP.')
  ...
  DO K=1,N_RL
    ...
    DUMMY=U_NOM(1:N_U,UINDEX1:UINDEX2,1:N_PF)
...
!  OPEN(FILE='new_yout.out',UNIT=25,STATUS='UNKNOWN')
!  WRITE(25,*) Y 
...
!    ALLOCATE(TBRAW(N_ZP(1)*N_YP,N_RL))
!    MONTH=12
...
! OPEN(FILE='new_yout1.out',UNIT=26,STATUS='UNKNOWN')
! WRITE(26,*) Y
...
IF(RANK.EQ.0)THEN
  ...
  OPEN(FILE='ystats.out',UNIT=20,STATUS='UNKNOWN',FORM='UNFORMATTED')
 ! OPEN(FILE='ystats.out',UNIT=9,STATUS='UNKNOWN')
